...
var InstanceAdapter = require("../services/instanceAdapter");
	...
	server.route({
		...
		handler : function (request, reply) {
			...
			.then(function (instance) {
				...
				return sshAdapter.startSshPolling(awsInstanceID)
				.then(function () {
					return awsAdapter.getPublicIPAddress(awsInstanceID);
				})
				.then(function (ipAddress) {
					console.log(ipAddress);
					//Update the DB with new State!
				})
				.catch(function (err) {
