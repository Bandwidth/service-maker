...
exports.register = function (server, options, next) {
	...
	if (process.env.AWS_DEFAULT_SECURITY_GROUP === undefined) {
		server.log([ "error", "rest" ], "The default security group is not set");
		throw new Error("Default Security Group not set");
	}
	...
	server.route({
		...
		handler : function (request, reply) {
			...
			var securityGroup = request.payload.securityGroup || process.env.AWS_DEFAULT_SECURITY_GROUP;
