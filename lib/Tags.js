...
Tags.applyTagsTo = function(tags, instanceId, callback) {
  var tries = 3;
  Tags._applyTags(tags, instanceId, tries, function lambda(instanceId, triesLeft) {
    if (instanceId) {
      callback(instanceId);
    } else if (triesLeft > 0) {
...
Tags._applyTags = function(tags, instanceId, tries, callback) {
  var params = {
